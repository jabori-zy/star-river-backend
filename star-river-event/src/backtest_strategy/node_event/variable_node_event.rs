...
use strategy_core::variable::custom_variable::{CustomVariable, VariableValue};
use strategy_core::variable::sys_varibale::SysVariable;
use strum::Display;
use strategy_core::node_infra::variable_node::variable_operation::UpdateVarValueOperation;
