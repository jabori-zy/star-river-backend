...
pub enum SignalEvent {
    ...
    ConditionNotMatch(ConditionNotMatchEvent), // 回测条件不匹配
...
pub type ConditionNotMatchEvent = NodeEvent<ConditionNotMatchPayload>;
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ConditionNotMatchPayload {
    #[serde(rename = "playIndex")]
    pub play_index: PlayIndex,
}

impl ConditionNotMatchPayload {
    pub fn new(play_index: PlayIndex) -> Self {
        Self { play_index }
    }
}
