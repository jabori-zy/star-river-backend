...
impl EventCenterSingleton {
    /// Initialize event center singleton with default configuration
    ...
    /// Initialize event center singleton with custom buffer sizes
    ///
    /// # Arguments
    ...
    /// Check if the event center has been initialized
