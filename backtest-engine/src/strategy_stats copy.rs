...
use virtual_trading::{context::VirtualTradingSystemContext, event::VtsEvent, VirtualTradingSystem};

use crate::{
    event::{StrategyStatsEvent, StrategyStatsUpdatedEvent},
    snapshot::{StatsSnapshot, StatsSnapshotHistory}, virtual_trading_system::BacktestVts,
};
...
where
    E: Clone + Send + Sync + 'static,
{
    pub fn new(mode: &'static str, strategy_id: StrategyId, vts: V) -> Self {
