...
use crate::{
    ...
    strategy::{strategy_command::BacktestStrategyCommand, PlayIndex},
};

// Local module imports
use super::{
    indicator_node_type::IndicatorNodeBacktestConfig,
    state_machine::IndicatorNodeStateMachine,
};

pub type IndicatorNodeMetadata = NodeMetadata<
    IndicatorNodeStateMachine,
    BacktestNodeEvent,
    BacktestNodeCommand,
