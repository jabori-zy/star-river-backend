...
impl FuturesOrderNode {
    ...
    //     // Create independent listener task for each receiver
    ...
    //         // Create independent listener stream for each receiver
    ...
    //                         match receive_result {
    //                             Some(Ok(node_event)) => {
    //                                 // Handle specific order events based on order configuration
    //                                 let mut context_guard = context.write().await;
