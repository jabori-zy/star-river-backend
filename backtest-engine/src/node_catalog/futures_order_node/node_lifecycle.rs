...
use crate::node_catalog::futures_order_node::state_machine::FuturesOrderNodeAction;
...
use crate::node::node_message::common_log_message::ListenExternalEventsMsg;
use crate::node::node_message::futures_order_node_log_message::GetSymbolInfoMsg;
use crate::node::node_message::futures_order_node_log_message::GetSymbolInfoSuccessMsg;
use crate::node::node_message::common_log_message::RegisterTaskMsg;
...
use crate::node::node_message::common_log_message::ListenVirtualTradingSystemEventMsg;
...
impl NodeLifecycle for FuturesOrderNode {
    ...
    async fn update_node_state(&self, trans_trigger: Self::Trigger) -> Result<(), Self::Error> {
        let (strategy_id, node_id, node_name, strategy_output_handle, mut state_machine) = self.with_ctx_read(|ctx| {
        ...
        for action in transition_result.actions() {
            ...
            match action {
                ...
                FuturesOrderNodeAction::LogNodeState => {
                    ...
                    NodeUtils::send_success_status_event(strategy_id, node_id.clone(), node_name.clone(), log_message.to_string(), current_state.to_string(), FuturesOrderNodeAction::LogNodeState.to_string(), &strategy_output_handle).await;
                }
                FuturesOrderNodeAction::ListenAndHandleExternalEvents => {
                    ...
                    NodeUtils::send_success_status_event(strategy_id, node_id.clone(), node_name.clone(), log_message.to_string(), current_state.to_string(), FuturesOrderNodeAction::ListenAndHandleExternalEvents.to_string(), &strategy_output_handle).await;
                ...
                FuturesOrderNodeAction::ListenAndHandleNodeEvents => {
                    ...
                    NodeUtils::send_success_status_event(strategy_id, node_id.clone(), node_name.clone(), log_message.to_string(), current_state.to_string(), FuturesOrderNodeAction::ListenAndHandleNodeEvents.to_string(), &strategy_output_handle).await;
                ...
                FuturesOrderNodeAction::ListenAndHandleStrategyCommand => {
                    ...
                    NodeUtils::send_success_status_event(strategy_id, node_id.clone(), node_name.clone(), log_message.to_string(), current_state.to_string(), FuturesOrderNodeAction::ListenAndHandleStrategyCommand.to_string(), &strategy_output_handle).await;
