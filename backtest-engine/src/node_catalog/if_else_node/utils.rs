...
// Get variable value from condition (extract from Variable struct)
pub fn parse_condition_left_value(
    left: &Variable,
    ...
    match (left, right) {
        ...
        (VariableValue::Number(left_value), VariableValue::Number(right_value)) => {
            match comparison_symbol {
                ...
                ComparisonSymbol::Equal => left_value == right_value,              // Decimal precise comparison
        ...
        (VariableValue::String(left_value), VariableValue::String(right_value)) => {
            match comparison_symbol {
                ...
                ComparisonSymbol::Contains => left_value.contains(right_value.as_str()), // A contains B
