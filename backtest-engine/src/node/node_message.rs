...
// Common log messages - Shared log messages used by multiple nodes
pub mod common_log_message {
    use serde::{Deserialize, Serialize};
    use strategy_core::{log_message, log_message::*};

    // Common state logs available for all nodes
    log_message!(
        NodeStateLogMsg,
        params: (
            node_name: String,
    ...
    // Listen to other node events - Available for most nodes
    log_message!(
        ListenNodeEventsMsg,
        params: (
            node_name: String,
    ...
    // Listen to strategy internal events - Available for most nodes
    log_message!(
    ...
    // Listen to strategy commands - Available for most nodes
    log_message!(
    ...
    // Listen to external events - Available for some nodes
    log_message!(
    ...
    // Listen to virtual trading system events - Available for some nodes
    log_message!(
    ...
    // Cancel async tasks - Available for all nodes
    log_message!(
        CancelAsyncTaskMsg,
        params: (
            node_name: String,
    ...
    // Async tasks canceled successfully - Available for most nodes
    log_message!(
    ...
    // Register task message - Available for some nodes
    log_message!(
        RegisterTaskMsg,
        params: (
            node_name: String,
    ...
    // Task registration successful message - Available for some nodes
    log_message!(
    ...
    // Event send successful message - Available for multiple nodes
    log_message!(
        SendEventSuccessMsg,
        params: (
            node_name: String,
    ...
    // Event send failed message - Available for multiple nodes
    log_message!(
        SendEventFailedMsg,
        params: (
            output_handle_id: String,
    ...
    // Get kline cache failed message - Available for multiple nodes
    log_message!(
    ...
    // Virtual trading system event listener terminated message - Available for some nodes
    log_message!(
...
// StartNode specific log messages
...
// IndicatorNode specific log messages
...
// KlineNode specific log messages
...
// IfElseNode specific log messages
...
// PositionNode specific log messages
...
// VariableNode specific log messages
...
// FuturesOrderNode specific log messages
...
// OrderNode specific log messages (reserved for future expansion)
pub mod order_node_log_message {
    // Temporarily empty, awaiting OrderNode implementation
}
