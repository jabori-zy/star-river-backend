...
impl CalculateIndicatorFunction {
    pub async fn calculate_indicator(
        ...
        match &indicator_config {
            ...
            // Price Transform
            IndicatorConfig::AVGPRICE(_) => CalculateIndicatorFunction::calculate_avgprice(kline_series),
            IndicatorConfig::MEDPRICE(_) => CalculateIndicatorFunction::calculate_medprice(kline_series),
            IndicatorConfig::TYPPRICE(_) => CalculateIndicatorFunction::calculate_typprice(kline_series),
            IndicatorConfig::WCLPRICE(_) => CalculateIndicatorFunction::calculate_wclprice(kline_series),

            // Volatility
            IndicatorConfig::ATR(atr_config) => CalculateIndicatorFunction::calculate_atr(kline_series, atr_config),
            IndicatorConfig::NATR(natr_config) => CalculateIndicatorFunction::calculate_natr(kline_series, natr_config),
            IndicatorConfig::TRANGE(_) => CalculateIndicatorFunction::calculate_trange(kline_series),

            // Pattern Recognition
            IndicatorConfig::CDL2CROWS(_) => CalculateIndicatorFunction::calculate_cdl2crows(kline_series),
            IndicatorConfig::CDL3BLACKCROWS(_) => CalculateIndicatorFunction::calculate_cdl3blackcrows(kline_series),
            ...
            IndicatorConfig::CDLHARAMICROSS(_) => CalculateIndicatorFunction::calculate_cdlharamicross(kline_series),
            IndicatorConfig::CDLHIGHWAVE(_) => CalculateIndicatorFunction::calculate_cdlhighwave(kline_series),
    ...
    // Get price source and timestamp
    ...
    // Get OHLCV (Open, High, Low, Close, Volume) + timestamp
    fn get_tohlcv(
        kline_series: Vec<Kline>,
