use super::{
    BacktestStrategy,
    strategy_state_machine::{BacktestStrategyStateAction, StrategyStateTransEvent},
};
use event_center::{
...
use star_river_core::error::{StarRiverErrorTrait, error_trait::Language, strategy_error::backtest_strategy_error::BacktestStrategyError};
use strategy_stats::backtest_strategy_stats::BacktestStrategyStats;
use virtual_trading::VirtualTradingSystem;
use crate::backtest_engine::{BacktestStrategyContext, strategy::strategy_log_message::StrategyStateLogMsg};
use chrono::Utc;

impl BacktestStrategy {
    pub async fn update_strategy_state(&mut self, event: StrategyStateTransEvent) -> Result<(), BacktestStrategyError> {
