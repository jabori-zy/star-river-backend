...
use node_context_trait::{NodeBaseContextTrait, NodeIdentity, NodeControl, NodeRelation, NodeStateMachineTrait, NodeHandleTrait};
use node_trait::NodeContextAccessor;
use serde::{Deserialize, Serialize};
use star_river_core::{
    custom_type::{NodeId, NodeName},
    error::node_error::backtest_node_error::BacktestNodeError,
};
use node_list::start_node::{StartNodeContext, state_machine::StartNodeAction};
use node_list::kline_node::{KlineNodeContext, state_machine::KlineNodeAction};
...
use crate::backtest_engine::node::node_trait::NodeLifecycle;
...
pub type StartNode = NodeBase<StartNodeContext, StartNodeAction>;

pub type KlineNode = NodeBase<KlineNodeContext, KlineNodeAction>;
