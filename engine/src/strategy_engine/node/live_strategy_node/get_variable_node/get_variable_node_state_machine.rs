...
impl LiveNodeTransitionAction for GetVariableNodeStateAction {
...
impl LiveStateChangeActions for GetVariableNodeStateChangeActions {
...
impl LiveNodeStateMachine for GetVariableNodeStateMachine {
    fn as_any(&self) -> &dyn Any {
        self
    }
