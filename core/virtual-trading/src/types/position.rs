...
pub struct VirtualPosition {
    ...
    pub unrealized_profit: Pnl,    // Unrealized profit/loss
    pub leverage: Leverage,        // Leverage multiplier
    pub force_price: f64,          // Liquidation price
    pub margin: Margin,            // Margin used by the position
