...
pub enum VariableValue {
    ...
    String(String),
    Boolean(bool),
    Enum(Vec<String>), // Option list for enum type
...
impl VariableValue {
    /// Parse VariableValue from JSON Value based on VariableValueType
    pub fn from_json_with_type(value: serde_json::Value, value_type: &VariableValueType) -> Result<Self, String> {
        match value_type {
            ...
            VariableValueType::Time => {
                ...
                // Frontend returns format: "2025-10-19 20:02:00 +08:00", with timezone
                use chrono::DateTime;
...
pub struct CustomVariable {
    pub var_name: String,              // Variable name
    pub var_display_name: String,      // Variable display name
    pub initial_value: VariableValue,  // Initial value
    pub previous_value: VariableValue, // Previous value
    pub var_value: VariableValue,      // Variable value
}
...
impl<'de> serde::Deserialize<'de> for CustomVariable {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        // Parse initial value using VariableValue::from_json_with_type based on type
        ...
        // Parse current value using VariableValue::from_json_with_type based on type
